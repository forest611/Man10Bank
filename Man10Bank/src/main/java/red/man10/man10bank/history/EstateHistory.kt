...
object EstateHistory {
    ...
    fun asyncShowBalanceTop(p: CommandSender, page:Int) = coroutineScope.launch {
    ...
    fun asyncShowLoanTop(p:CommandSender,page:Int) = coroutineScope.launch {
    ...
    fun asyncShowEstate(p:CommandSender,uuid:UUID) = coroutineScope.launch {
    ...
    fun asyncShowServerEstate(p:CommandSender) = coroutineScope.launch{
